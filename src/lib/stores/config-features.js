export const config = {
	mapTitle: 'financial-literacy', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-financial-literacy.vercel.app/', // The url provided when deploying the map on Vercel
